...
export function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      subtitleEN: 'AI-powered medical advice web application',
      descriptionFR:
        "Plateforme e-santé exploitant l'IA pour fournir des conseils médicaux personnalisés selon les symptômes et le profil du patient. Interface interactive avec représentation du corps humain pour localisation précise des symptômes.",
      descriptionEN:
        "E-health platform using AI to provide personalized medical advice based on symptoms and patient profile. Interactive interface with human body representation for precise symptom location.",
      techs: ['Next.js', 'NestJS', 'MySQL', 'Rasa', 'OpenAI LLMs', 'React'],
      demo: '#',
      source: '#',
      images: ['/projects/Home.jpg', '/projects/Inscription.jpg', '/projects/Articles.jpg', '/projects/corps.jpg', '/projects/consultation.jpg'],
    },
  ]
