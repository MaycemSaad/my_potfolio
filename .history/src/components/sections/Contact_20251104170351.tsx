      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-stretch">
          ...
          <div className="flex flex-col">
            <div className={`bg-gray-900/90 dark:bg-gray-900/90 backdrop-blur-xl rounded-2xl p-8 border border-gray-700/50 dark:border-gray-700/50 shadow-2xl flex-1 min-h-[600px] flex flex-col ${
              ...
              <div className="flex-1 space-y-6">
                {contactMethods.map((method, index) => (
                  ...
                  >
                    <div className="bg-gray-800/70 dark:bg-gray-800/70 rounded-xl p-5 border border-gray-700/50 dark:border-gray-700/50 hover:border-blue-400/50 dark:hover:border-blue-400/50 shadow-lg hover:shadow-xl transition-all duration-300 hover:translate-y-[-2px]">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-white/90 dark:text-white/90 font-medium text-lg mb-1">
                            {method.value}
                          </p>
              ...
              <div className="mt-8 pt-6 border-t border-gray-700/50 dark:border-gray-700/50">
                <h4 className="font-semibold text-white dark:text-white mb-4 text-lg">
          ...
          <div className="flex flex-col">
            <div className={`bg-gray-900/90 dark:bg-gray-900/90 backdrop-blur-xl rounded-2xl border border-gray-700/50 dark:border-gray-700/50 p-8 shadow-2xl flex-1 min-h-[600px] flex flex-col ${
                    ...
                    <div className="space-y-6 flex-1">
                      <div className="grid md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                          ...
                          <input
                            ...
                            className="w-full px-4 py-3 rounded-xl bg-gray-800/70 dark:bg-gray-800/70 border border-gray-700 dark:border-gray-700 text-white dark:text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                            required
                          />
                        </div>
                        <div className="space-y-2">
                      ...
                      <div className="space-y-2 flex-1 flex flex-col">
                        ...
                        <textarea
                          ...
                          className="w-full px-4 py-3 rounded-xl bg-gray-800/70 dark:bg-gray-800/70 border border-gray-700 dark:border-gray-700 text-white dark:text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all resize-none flex-1"
                          required
                        ></textarea>
                      </div>
                    </div>
